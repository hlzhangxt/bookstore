...
<tiles:insertTemplate template="/template.jsp" flush="true">
	<tiles:putAttribute name="content">
		...
		<struts:if test="parent != null">
			...
			<input type=button class=button onclick="if(!confirm('Are you sure to delete it？')) return; location='<struts:url action="category" includeParams="none" />?action=delete&parent.cate_id=<struts:property value="parent.cate_id" />'; " value="Delete The Category" />
		</struts:if>
		<br/>
		<br/>
