...
<tiles:insertTemplate template="/template.jsp" flush="true">
	<tiles:putAttribute name="content">
		...
		<div align=center>
			<br /><br />
			<input type=button class=button value="Pay" onclick="if(!confirm('Are you sure to pay now？'))	return; location='<struts:url action="cart" includeParams="none" />?action=pay'" />
